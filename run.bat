...
start "PoolPay Backend" cmd /k "cd poolpay-backend && .venv\Scripts\activate && python -m uvicorn app.main:app --reload"
timeout /t 3 /nobreak >nul
start "PoolPay Frontend" cmd /k "cd poolpay-frontend && npm run dev"
